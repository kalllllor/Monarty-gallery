...
export const StuccoMaterial = ({ index }) => {
  const [colorMap] = useLoader(TextureLoader, [
    `/textures/baked-textures/stucco_${index}.jpg`,
  ]);
...
export const AzurMaterial = () => {
  const [colorMap] = useLoader(TextureLoader, [
    `/textures/baked-textures/azur.png`,
  ]);
...
export const GlassMaterial = () => {
  ...
  const normalScale = new THREE.Vector2(
    options.normalScale
  );

  const clearcoatNormalScale = new THREE.Vector2(
...
export const FrameMaterial = ({ index }) => {
  const [colorMap] = useLoader(TextureLoader, [
    `/textures/baked-textures/frame_${index}.jpg`,
  ]);
...
export const PaintingMaterial = ({ index }) => {
  const [colorMap] = useLoader(TextureLoader, [
    `/textures/baked-textures/${index}-painting.jpg`,
  ]);
...
export const SculptureMaterial = () => {
  const [colorMap] = useLoader(TextureLoader, [
    `/textures/baked-textures/rzezba.jpg`,
  ]);
